...
const BLOCK_DEFINITIONS: BlockDefinition[] = [
  ...
  { blockType: 'LOOKBACK',  category: 'indicator', label: '이전값',    description: 'N봉 전 값 참조',         defaultParams: { period: 1 } },
  // 조건
  ...
  { blockType: 'CONSECUTIVE',category: 'condition', label: 'N봉 연속',  description: 'N봉 연속으로 참일 때',   defaultParams: { count: 3 } },
  ...
  { blockType: 'NOT',        category: 'logic',     label: 'NOT',       description: '조건 부정 (반전)',        defaultParams: {} },
  // 액션
